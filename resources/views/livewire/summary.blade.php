...
<script>
    // Function to disable the submit button and show a message when the application is submitted.
    function handleFormSubmission() {
        var submitButton = document.getElementById('submitButton');
        var isApplicationSubmitted = {{ $applicant->submitted ? 'true' : 'false' }};

        // Disable the submit button if the application is already submitted.
        if (isApplicationSubmitted) {
            submitButton.disabled = true;
            alert('Your application has already been submitted. You cannot submit again.');
        }
    }
